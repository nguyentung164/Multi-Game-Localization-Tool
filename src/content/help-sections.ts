  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Sau khi kiểm tra file, panel ước tính hiện 3 chỉ số: câu cần gọi API, số luồng song song (và key dự phòng nếu có), và thời gian ước tính đã chia theo luồng.",
      ...
      },
      {
        ...
        body: [
          "Sau dịch toàn bộ, duyệt diff: chọn/bỏ chọn từng dòng, sửa bản dịch rồi bấm Lưu file — lúc đó QA mới chạy lại trên chữ vừa sửa. Chỉ gõ trong ô thì cột Quy tắc/Chi tiết vẫn là lần kiểm tra trước.",
      ...
      {
        id: "legend-history",
        title: "Lịch sử và hoàn tác",
        body: [
          "Mỗi lần Apply tạo backup có manifest trong AppData.",
          "Thư mục game (deploy) nằm ở Cài đặt: đặt đường dẫn tới …\\BepInEx\\Translation\\vi\\Text. Apply sẽ backup và ghi đè _AutoGeneratedTranslations.txt trong thư mục đó (ngoài file nguồn đang dịch).",
          "Restore chỉ vào đúng file đang được chọn/inspect; luôn tạo safety backup trước khi ghi.",
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Trong AppData của app, liệt kê tại Lịch sử & hoàn tác của Legend. Safety backup cũng xuất hiện trong danh sách đó, không nằm trong Backup Center của Civilization VII.",
      },
    ],
  },
]
